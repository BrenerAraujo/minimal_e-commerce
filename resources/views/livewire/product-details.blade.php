<div>
    <div class="flex gap-5 p-20">
        ...
        <div>
            ...
            <div class="my-3">
                <a href="#" class="flex gap-2 justify-center w-full rounded bg-blue-600 px-12 py-2 text-sm font-medium text-white text-center shadow hover:bg-blue-700 focus:outline-none focus:ring active:bg-blue-500 sm:w-auto">
