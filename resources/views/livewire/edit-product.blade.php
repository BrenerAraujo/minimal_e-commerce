            ...
            <form wire:submit="update">
                ...
                <div
                    ...
                    <div class="sm:col-span-3">
                        <label for="af-submit-application-product-name"
                    ...
                    <div class="sm:col-span-9">
                        <div class="sm:col-span-9">
                            <input id="af-submit-application-product-name" wire:model="product_name" type="text"
                    ...
                    <div class="sm:col-span-9">
                        <input id="af-submit-application-price" type="text" inputmode="decimal" pattern="[0-9]*[.,]?[0-9]*" wire:model="product_price"
                ...
                <div
                    ...
                    <div class="sm:col-span-3">
                        <label for="af-submit-application-image"
                               class="inline-block text-sm font-medium text-gray-500 mt-2.5 dark:text-neutral-500">
                            Product Image
                        </label>
                    </div>
                    ...
                    <div x-data="{ uploading: false, progress: 0 }" x-on:livewire-upload-start="uploading = true" x-on:livewire-upload-finish="uploading = true" x-on:livewire-upload-error="uploading = false" x-on:livewire-upload-progress="progress = $event.detail.progress" class="sm:col-span-9">
                        <label for="af-submit-application-image" class="sr-only">Choose Image</label>
                        <input type="file" wire:model="photo" id="af-submit-application-image"
                ...
                <button type="submit"
                    ...
                    <div wire:loading class="animate-spin inline-block size-4 border-[3px] border-current border-t-transparent text-white-600 rounded-full dark:text-blue-500" role="satus" aria-label="loading">
