<div class="bg-gray-100 shadow-sm rounded-lg hover:border border-blue-400 p-1">
    <a wire:navigate href="/product/{{ $product->id }}/details">
        <div>
            <img src="{{ $product->image ? Storage::url($product->image) : asset('images/placeholder-image.jpg') }}" alt="Product-image" class="rounded-t-lg object-cover" height="400px" width="400px">
        </div>
