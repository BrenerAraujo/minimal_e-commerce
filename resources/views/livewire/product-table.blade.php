                ...
                <div class="p-1.5 min-w-full inline-block align-middle">
                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
                        ...
                        <tr>
                            @include('livewire.theaders.th', [
                                'name' => 'name',                 //Column Name from DB
                                'columnName' => 'Product Name',   //Display Name
                            ])
                            ...
                            @if(count($products) > 0)
                                @foreach($products as $product)
                                    <tr wire:key="{{ $product->id }}">
                                            ...
                                            <div class="ps-6 lg:ps-3 xl:ps-0 pe-6 py-3">
                                                <a wire:navigate href="">
                                                    <div class="flex items-center gap-x-3">
                                                        <img src="{{ Storage::url($product->image) }}" alt="Avatar"
                                        ...
                                        <td class="size-px whitespace-nowrap">
                                            <div class="px-6 py-1.5">
                                                <a wire:navigate wire:click="delete({{ $product->id }}" wire:confirm.prompt="Are you shure? \n\nType DELETE to confirm|DELETE" href=""
                                                   class="inline-flex items-center gap-x-1 text-sm text-red-500 decoration-2 hover:underline focus:outline-none focus:underline font-medium dark:text-blue-500">
                                                    Delete
                                                </a>
                                            </div>
                                        </td>
                    ...
                    <div class="px-6 py-4 grid gap-3 md:flex md:justify-between md:items-center border-t border-gray-200 dark:border-neutral-700">
                        <div class="flex gap-2">
                            <label class="w-32 text-sm font-medium text-gray-900">
                                Per Page
                            </label>
